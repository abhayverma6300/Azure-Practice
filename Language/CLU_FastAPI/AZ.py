...
# Ensure the environment variables are set before proceeding
if not clu_endpoint or not clu_key:
    raise ValueError("CLU endpoint or key not found in environment variables.")

# get secrets
project_name = "Zarvis"
deployment_name = "Jarvis-01"
