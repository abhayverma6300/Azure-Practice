...
- AZURE_COMPUTERVISION_SUBSCRIPTION_KEY: Azure Computer Vision subscription key.
- AZURE_COMPUTERVISION_ENDPOINT: Azure Computer Vision endpoint URL.
...
def analyze_image_from_url(image_url):
    ...
    subscription_key = os.getenv("AZURE_COMPUTERVISION_SUBSCRIPTION_KEY")
    endpoint = os.getenv("AZURE_COMPUTERVISION_ENDPOINT")

    # Check if environment variables are set
    if not all([subscription_key, endpoint]):
        raise ValueError("Please set both AZURE_COMPUTERVISION_SUBSCRIPTION_KEY and AZURE_COMPUTERVISION_ENDPOINT environment variables.")
